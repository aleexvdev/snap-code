        ...
        <div className="w-full h-8 p-0.5 rounded-md bg-[#272727]">
          <div className="relative w-full flex items-center justify-between gap-3 flex-1 px-1 h-full overflow-hidden bg-[#272727] rounded-md">
            {RADIUS.map((item) => (
              <>
                <motion.div
                  className="absolute top-0 left-0 h-full w-1/4 bg-[#404040] rounded-sm py-1"
                ...
                <button
                  key={item}
                  className="relative z-10 w-1/4 h-full flex items-center justify-center py-1 px-2 transition-colors"
